...
function realSwipe(subject, direction, options = {}) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const startPosition = getCypressElementCoordinates_1.getCypressElementCoordinates(subject, position);
        ...
        log.snapshot("before");
        yield fireCdpCommand_1.fireCdpCommand("Input.dispatchTouchEvent", {
            type: "touchStart",
        ...
        yield forEachSwipePosition({
            ...
            direction,
            startPosition,
        }, (position) => fireCdpCommand_1.fireCdpCommand("Input.dispatchTouchEvent", {
            type: "touchMove",

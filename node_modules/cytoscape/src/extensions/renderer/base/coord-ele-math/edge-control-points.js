    ...
    for( var i = 0; i < pairEdges.length; i++ ){
      ...
      if( !ptCacheHit ){
        ...
        if( !pairEdges.calculatedIntersection && src !== tgt && ( pairEdges.hasBezier || pairEdges.hasUnbundled ) ){
          ...
          var srcOutside = nodeFcnCaller.intersectLine(
            src,
            tgtPos.x,
            tgtPos.y,
            r
          ...
          var tgtOutside = nodeFcnCaller.intersectLine(
            tgt,
            srcPos.x,
            srcPos.y,
            r
          ...
          if(
            nodeFcnCaller.checkPoint( srcOutside[0], srcOutside[1], tgt, 0, r )  &&
            nodeFcnCaller.checkPoint( tgtOutside[0], tgtOutside[1], src, 0, r )
          ){
            vectorNormInverse = {};
            badBezier = true;
          }
        ...
        if( rs.edgeType === 'bezier' ){
          ...
          if( badStart || badAStart || closeStartACp ){
            ...
            var srcCtrlPtIntn = nodeFcnCaller.intersectLine(
              src,
              cpProj.x,
              cpProj.y,
              r
          ...
          if( badEnd || badAEnd || closeEndACp ){
            ...
            var tgtCtrlPtIntn = nodeFcnCaller.intersectLine(
              tgt,
              cpProj.x,
              cpProj.y,
              r

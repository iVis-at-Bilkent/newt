...
//  var nodeQtipFunction = appUtilities.nodeQtipFunction.bind(appUtilities);
   ...
   */
  function overridePanzoomReset(cy) {
      ...
      if ($resetButton.length > 0) {
        ...
        $resetButton.on('mousedown', function(e) {
          ...
          if (visibleElements.length === 0) {
            // console.log('No visible elements, performing default reset');
            cy.reset();
            return false;
          }
          ...
          if (annotationItems.length > 0) {
            annotationBbox = calculateAnnotationBoundingBox(annotationItems, cy);
          }
          ...
          // console.log('Calculated zoom:', zoom, 'pan:', {x: panX, y: panY});
   ...
   */
  function calculateAnnotationBoundingBox(annotationItems, cy) {

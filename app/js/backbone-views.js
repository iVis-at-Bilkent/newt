...
var ReactionTemplateView = Backbone.View.extend({
  ...
  initialize: function() {
    ...
    $(document).on("click", "#metabolic-reaction-regulator-checkbox", function(event) {
      ...
      self.setMultimerCheckboxEnabled(multimerEnabled);

...
inspectorUtilities.fillInspectorStateAndInfos = function (
  ...
  for (var i = 0; i < stateAndInfos.length; i++) {
    (function (i) {
      ...
      if (chiseInstance.elementUtilities.mapType != "AF") {
        var visibilityCheckboxHtml =
          "<input type='checkbox' class='visibility-checkbox' id='inspector-visibility-checkbox" +
          i +
          "' " +
          "title='Visible?' " +
      ...
      if (state.clazz == "state variable") {
        ...
        var uioHtml =
          "<div>" +
          visibilityCheckboxHtml +
          "<input type='text' id='inspector-unit-of-information-label" +
          i +
          "' class='inspector-input-box' style='width: " +
          total +
          "px;' value='" +
        ...
        */
        ...
        $("#inspector-residue-variable").append(
          "<div>" +
            visibilityCheckboxHtml +
            // state variable - variable
            "<input type='text' id='inspector-residue-variable-variable" +
            i +
            "' class='inspector-input-box' style='width: " +
            width / 2.5 +
            "px;' value='" +
            sanitizeInfoboxVal(state.residue.variable) +
            "'/>" +
            getInfoboxDetailsBtnHtml(i) +
            "<img width='16px' height='16px' id='inspector-delete-state-and-info" +
            i +
        ...
        $("#inspector-residue-variable-variable" + i)
          .unbind("change")
          .on("change", function () {
            chiseInstance.changeStateOrInfoBox(
              nodes,
        ...
        $("#inspector-binding-region").append(
          "<div>" +
            visibilityCheckboxHtml +
            // state variable - variable
            "<input type='text' id='inspector-binding-region-variable" +
            i +
            "' class='inspector-input-box' style='width: " +
            width / 2.5 +
            "px;' value='" +
            sanitizeInfoboxVal(state.region.variable) +
            "'/>" +
            getInfoboxDetailsBtnHtml(i) +
            "<img width='16px' height='16px' id='inspector-delete-state-and-info" +
            i +
        ...
        $("#inspector-binding-region-value" + i)
          .unbind("change")
          .on("change", function () {
            chiseInstance.changeStateOrInfoBox(
              nodes,
        ...
        $("#inspector-binding-region-variable" + i)
          .unbind("change")
          .on("change", function () {
            chiseInstance.changeStateOrInfoBox(
              nodes,
  ...
  $("#inspector-residue-variable").append(
    "<img width='16px' height='16px' id='inspector-add-residue-variable-variable' src='app/img/add.svg' class='pointer-button'/>"
  );
  $("#inspector-binding-region").append(
    "<img width='16px' height='16px' id='inspector-add-binding-region-variable' src='app/img/add.svg' class='pointer-button'/>"
  );
  ...
  if (
    chiseInstance.elementUtilities.canHaveOneUnitOfInformation(nodes) &&
    unitOfInfoCount == 0
  ) {
    $("#inspector-unit-of-informations").append(
      "<img width='16px' height='16px' id='inspector-add-unit-of-information' src='app/img/add.svg' class='pointer-button'/>"
...
inspectorUtilities.handleSBGNInspector = function () {
  ...
  if (allNodes || allEdges) {
    ...
    var title =
      classInfo == "" ? "Visual Properties" : classInfo + " Visual Properties";
    ...
    if (allNodes) {
      ...
      if (commonStateAndInfos) {
        ...
        if (
          chiseInstance.elementUtilities.trueForAllElements(
            selectedEles,
            chiseInstance.elementUtilities.canHaveResidueVariable
          )
        ) {
          fillStateAndInfos = true;
          html +=
          ...
          html +=
            ...
            width +
            "px; text-align:right; padding-right: 5px;'>" +
            "<font class='sbgn-label-font'>Residue Variables</font>" +
            "</td>" +
            "<td id='inspector-residue-variable' style='padding-left: 5px; width: '" +
            width +
            "'></td></tr>";
        }
        ...
        if (
          chiseInstance.elementUtilities.trueForAllElements(
            selectedEles,
            chiseInstance.elementUtilities.canHaveBindingRegion
          )
        ) {
          fillStateAndInfos = true;
          html +=
          ...
          html +=
            ...
            width +
            "px; text-align:right; padding-right: 5px;'>" +
            "<font class='sbgn-label-font'>Binding Region</font>" +
            "</td>" +
            "<td id='inspector-binding-region' style='padding-left: 5px; width: '" +
            width +
            "'></td></tr>";
        }

        if (
          chiseInstance.elementUtilities.canHaveUnitOfInformation(selectedEles)
        ) {
          fillStateAndInfos = true;
          ...
          var unit =
            chiseInstance.elementUtilities.canHaveMultipleUnitOfInformation(
              ...
              ? "Units"
              : "Unit";
          var unit = chiseInstance.elementUtilities.canHaveOneUnitOfInformation(
            selectedEles
          )
            ? "Unit"
            : unit;
      ...
      commonIsActive = chiseInstance.elementUtilities.getCommonProperty(
        selectedEles,
        function (ele) {
      ...
      commonIsHypothetical = chiseInstance.elementUtilities.getCommonProperty(
        selectedEles,
        function (ele) {
      ...
      activeCheck = chiseInstance.elementUtilities.trueForAllElements(
        selectedEles,
        chiseInstance.elementUtilities.canBeActive
      );
      hypotheticalCheck = chiseInstance.elementUtilities.trueForAllElements(
        selectedEles,
        chiseInstance.elementUtilities.canBeHypothetical
      );
      ...
      if (activeCheck) {
        html +=
          ...
          width +
          "px; text-align:right; padding-right: 5px;'>" +
          "<font class='sbgn-label-font'>Active</font>" +
          "</td>" +
          "<td style='padding-left: 5px; width: '" +
          width +
          "'><input type='checkbox' id='inspector-is-active'></td></tr>";
      }
      ...
      if (hypotheticalCheck) {
        html +=
          ...
          width +
          "px; text-align:right; padding-right: 5px;'>" +
          "<font class='sbgn-label-font'>Hypothetical</font>" +
          "</td>" +
          "<td style='padding-left: 5px; width: '" +
          width +
          "'><input type='checkbox' id='inspector-is-hypothetical'></td></tr>";
      }
      ...
      if (
        ...
        for (var i = 0; i < orderings.length; i++) {
          ...
          var optionStr =
            "<option id='" + optionId + "'" + " value='" + optionVal + "'";
    ...
    if (selectedEles.length === 1) {
      ...
      function addCollapsibleSection(
        ...
        var panelHeadingClass = openByDefault
          ? "panel-heading"
    ...
    if (type == "node") {
      ...
      function updateBackgroundDeleteInfo() {
        ...
        if (!hasBackgroundImage) {
          ...
          imageURL =
            chiseInstance.elementUtilities.getBackgroundImageURL(selectedEles);
      ...
      $("#inspector-is-active").on("click", function () {
        chiseInstance.setActiveStatus(
          selectedEles,
          $("#inspector-is-active").prop("checked")
        );
      ...
      $("#inspector-is-hypothetical").on("click", function () {
        chiseInstance.setHypotheticalStatus(
          selectedEles,
          $("#inspector-is-hypothetical").prop("checked")
        );
        //chiseInstance.setMultimerStatus(selectedEles, $('#inspector-is-active').prop('checked'));
      });
      ...
      $("#inspector-set-as-default-button").on("click", function () {
        ...
        if (appUtilities.undoable) {
          ...
          var defaults =
            chiseInstance.elementUtilities.getDefaultProperties(sbgnclass);
    ...
    for (var i = 0; i < listedNodes.length; i++) {
      ...
      if (errorCode != "pd10112") {
        ...
        if (errorCode == "pd10110" || errorCode == "pd10128")
          ...
          var radioText = chiseInstance.elementUtilities.isLogicalOperator(
            listedNodes[i]
          )
            ? listedNodes[i].data().class.toUpperCase()
...
inspectorUtilities.handleSBGNConsole = function (
  ...
  if (errors.length != 0 && !notPD) {
    ...
    html +=
      '<p style="text-align:center" >' + errors[currentPage].text + "</p>";
    html +=
